...
- CHG completed 但没 verified、verified 后没 reviewed、或 reviewed 后没归档？Stop hook **阻止退出**（未审计为 warning 级软门，提醒先跑 R 审计）
...
| **Stop** | AI 想结束会话 | 未完成 / 未验证 / 未归档 → exit 2 阻止退出；已验证未审计 → warning 级软门提醒先跑 R 审计 |
