...
| Skill 定义 | `paceflow/skills/*/SKILL.md` | 6 |
| Hook 模板 | `paceflow/hooks/templates/*.md` | 5 |
| Change 模板 | `paceflow/skills/change-management/templates/*.md` | 2 |
| 配置 | `paceflow/config/settings-hooks-excerpt.json` | 1 |
| Plugin 元数据 | `.claude-plugin/plugin.json` + `hooks/hooks.json` | 2 |
...
**审查文件**：
- `paceflow/skills/pace-workflow/SKILL.md` — PACE 协议核心流程
- `paceflow/skills/artifact-management/SKILL.md` — Artifact 管理规则
- `paceflow/skills/change-management/SKILL.md` — 变更管理模块
- `paceflow/skills/pace-knowledge/SKILL.md` — 知识库笔记管理
- `paceflow/hooks/templates/*.md`（5 个 Hook 模板）
- `paceflow/skills/change-management/templates/*.md`（2 个变更模板）
...
Skills（6 文件）：
1. paceflow/skills/pace-workflow/SKILL.md — PACE 协议核心流程
2. paceflow/skills/artifact-management/SKILL.md — Artifact 管理规则
3. paceflow/skills/change-management/SKILL.md — 变更管理模块
4. paceflow/skills/pace-knowledge/SKILL.md — 知识库笔记管理
5. paceflow/skills/pace-bridge/SKILL.md — Superpowers 桥接
6. paceflow/skills/paceflow-audit/SKILL.md — 全面审查框架
...
Change Templates（2 文件）：
- paceflow/skills/change-management/templates/change-record.md
- paceflow/skills/change-management/templates/change-implementation_plan.md

审查维度：

A. 模板完整性（最重要）
- hooks/templates/ 5 个 artifact 模板是否存在且格式正确
- change-management/templates/ 2 个变更模板是否存在且格式正确
